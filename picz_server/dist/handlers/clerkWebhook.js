...
var createNewUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, first_name, last_name, email_addresses, email, imageUrls, newUser, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = req.body.data, id = _a.id, first_name = _a.first_name, last_name = _a.last_name, email_addresses = _a.email_addresses;
